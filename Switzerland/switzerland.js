const sdgData = [
    ...
    { goal: "Zero Hunger", progress: 94 },
    { goal: "Good Health and Well-being", progress: 98 },
    { goal: "Quality Education", progress: 97 },
    { goal: "Gender Equality", progress: 88 },
    ...
    { goal: "Climate Action", progress: 82 },
    { goal: "Life Below Water", progress: 85 },
    { goal: "Life on Land", progress: 87 },
    { goal: "Peace, Justice and Strong Institutions", progress: 95 },
    { goal: "Partnerships for the Goals", progress: 93 }
];
